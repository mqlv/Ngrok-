...
install_ngrok(){
	...
	cd ngrok
	\cp -rf /etc/letsencrypt/live/bravewall.top/chain.pem assets/client/tls/ngrokroot.crt
	\cp -rf /etc/letsencrypt/live/bravewall.top/cert.pem assets/server/tls/snakeoil.crt
	\cp -rf /etc/letsencrypt/live/bravewall.top/privkey.pem assets/server/tls/snakeoil.key
	# 替换下载源地址
